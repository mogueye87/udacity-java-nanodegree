...
public class CarControllerTest {
	...
	public void setup() {
		...
		given(mapsClient.getAddress(location)).willReturn(location);
	}
	...
	public void listCars() throws Exception {
		...
		assertThat(expectedCar.getId(), is(equalTo(car.getId())));
	}
	...
	public void findCar() throws Exception {
		...
		Car car = getCar();
		car.setId(1L);
		mvc.perform(get(new URI("/cars/" + car.getId())).contentType(MediaType.APPLICATION_JSON_UTF8)
	...
	public void deleteCar() throws Exception {
		...
		Car car = getCar();
		car.setId(1L);
		mvc.perform(delete(new URI("/cars/" + car.getId())).contentType(MediaType.APPLICATION_JSON_UTF8)
